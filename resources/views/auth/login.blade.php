...
<body class="hold-transition login-page" style="background-image: url({{asset('images/lasureco-logo.png')}});background-repeat:no-repeat;background-position-x:center;">
<div class="login-box" id="app">
  <!-- /.login-logo -->
  <div class="card" style="opacity: 0.98;">
